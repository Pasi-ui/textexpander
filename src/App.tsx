...
cat > /Users/pascalzimmermann/textexpander/src/App.tsx << 'EOF'
import { useState, useEffect } from "react";
import { invoke } from "@tauri-apps/api/core";
import "./App.css";
...
export default App;
EOFesxyxasdacat > /Users/pascalzimmermann/textexpander/src/App.tsx << 'EOF'
import { useState, useEffect } from "react";
import { invoke } from "@tauri-apps/api/core";
import "./App.css";
...
export default App;
EOFascd /Users/pascalzimmermann/textexpander
git add .
git commit -m "React UI fertig - Kuerzel hinzufuegen und loeschen funktioniert"
git push
cd /Users/pascalzimmermann/textexpander
git add .
git commit -m "React UI fertig - Kuerzel hinzufuegen und loeschen funktioniert"
git push
git add .
